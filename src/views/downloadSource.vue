    ...
    <div class="container P_top_40 P_bottom_40">
        <v-expansion-panels variant="accordion">
            <v-expansion-panel class="mb-3">
                <v-expansion-panel-title class="font12 mainColor fontBold">{{ $t('layout.products') }}</v-expansion-panel-title>
                    ...
                    <div class="d-flex align-items-start gap30 position-relative">
                        <v-expansion-panels variant="accordion">
                            <v-expansion-panel v-for="itemExpand in downloadFiles" :key="itemExpand" class="mb-3">
                                <v-expansion-panel-title class="font12 mainColor fontBold"><span class="M_end_15">{{ itemExpand.category_name }}</span> <font-awesome-icon :icon="['fas', 'angle-double-down']" /></v-expansion-panel-title>
                                <v-expansion-panel-text>
                                    <div class="d-flex align-items-start gap30 position-relative">
                                        <v-expansion-panels class="nastedExpand" variant="accordion">
                                            <v-expansion-panel v-for="itemdownloadFiles in itemExpand.products" :key="itemdownloadFiles" class="mb-3">
                                                <v-expansion-panel-title class="font12 mainColor fontBold"><span class="M_end_15">{{ itemdownloadFiles.product_name }}</span> <font-awesome-icon :icon="['fas', 'angle-double-down']" /></v-expansion-panel-title>
                                                <v-expansion-panel-text>
                                                    <div class="d-flex flex-column align-items-start gap5 position-relative">
                                                        <span v-for="file in itemdownloadFiles.files" :key="file">
                                                            <a class="btn p-0 font12 default_link" :href="file" download>
            ...
            <v-expansion-panel class="mb-3">
                <v-expansion-panel-title class="font12 mainColor fontBold">{{ $t('layout.generalInformation') }}</v-expansion-panel-title>
                <v-expansion-panel-text class="nastedExpand">
                    <div class="d-flex align-items-start gap30 position-relative">
                        <v-expansion-panels variant="accordion">
            ...
            <v-expansion-panel class="mb-3">
                <v-expansion-panel-title class="font12 mainColor fontBold">{{ $t('layout.communicationFiles') }}</v-expansion-panel-title>
                <v-expansion-panel-text class="nastedExpand">
                    <div class="d-flex align-items-start gap30 position-relative">
                        <v-expansion-panels variant="accordion">
